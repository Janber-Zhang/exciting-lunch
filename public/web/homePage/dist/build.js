...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./app.less", function() {
				var newContent = require("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./app.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/style-rewriter.js?id=_v-5b2e6054&scoped=true!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/selector.js?type=style&index=0!./main.vue", function() {
				var newContent = require("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/style-rewriter.js?id=_v-5b2e6054&scoped=true!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/selector.js?type=style&index=0!./main.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// <template>
	//   <div class="main">
	//     <order-room v-if="have_name"></order-room>
	//     <enter-name v-else @on-ok="have_name = true"></enter-name>
	//   </div>
	// </template>
	...
	exports.default = {
	  ...
	  components: {
	    enterName: _name2.default,
	    orderRoom: _room2.default
	  },
	  data: function data() {
	    return {
	      have_name: false
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/style-rewriter.js?id=_v-6d37c7b4&scoped=true!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/selector.js?type=style&index=0!./name.vue", function() {
				var newContent = require("!!../../../../../node_modules/_css-loader@0.23.1@css-loader/index.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/style-rewriter.js?id=_v-6d37c7b4&scoped=true!../../../../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!../../../../../node_modules/_vue-loader@8.7.1@vue-loader/lib/selector.js?type=style&index=0!./name.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _statistics = __webpack_require__(27);
	...
	exports.default = {
	  ...
	  methods: {
	    socketInit: function socketInit() {
	      ...
	      this.SOCKET.on('connect', function () {
	        vm.SOCKET.emit('join', (0, _stringify2.default)(vm.user));
	      });
	      //监听消息
	    ...
	    dealMsgInfo: function dealMsgInfo(user, msg) {
	      this.msgArr.push({ user: user, msg: msg });
	      setTimeout(function () {
	    ...
	    dealOrderInfo: function dealOrderInfo(orders) {
	      ...
	      this.all_items.forEach(function (_item) {
	        var not_found = true;
	        orders.forEach(function (order) {
	          if (order.id == _item.id) {
	            not_found = false;
	            _item.num = order.count[_this.user._id] || '';
	          }
	        });
	        if (not_found) {
	          _item.num = '';
	    ...
	    chooseOne: function chooseOne(item) {
	      this.SOCKET.emit('order', (0, _stringify2.default)(item), (0, _stringify2.default)(this.user));
	    },
	  ...
	  computed: {
	    show_list: function show_list() {
	      ...
	      if (this.filter_str) {
	        var new_list = this.all_items.filter(function (item) {
	          if (item.name.indexOf(_this2.filter_str) > -1) {
	            return true;
	          } else {
	            return false;
	          }
